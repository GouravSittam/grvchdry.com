	...
	workExperience: [
		{
			...
			logo: "/gokboru.png",
			location: "Remote",
			website: config.companies.GokboruTech,
			positions: [
				{
					...
					responsibilities: [
						"Developed 3+ full-stack web applications using the MERN stack (MongoDB, Express.js, React.js, Node.js), achieving a 30% performance improvement through code optimization and efficient database queries",
						"Built responsive React components with modern JavaScript (ES6+) and implemented RESTful APIs using Node.js and Express, reducing page load times by 40%",
						"Designed and deployed scalable MongoDB database schemas to ensure seamless data management and retrieval across applications",
						"Collaborated in Agile development sprints, participating in daily standups, sprint planning, and code reviews to deliver production-ready solutions on schedule",
						"Utilized Tailwind CSS to create mobile-first, responsive user interfaces that maintained consistency across different screen sizes and devices",
						"Implemented version control best practices using Git and GitHub, managing feature branches, pull requests, and code merges in a team environment",
						"Debugged complex frontend-backend integrations, identifying and resolving performance bottlenecks and functionality issues",
						"Gained hands-on experience with modern development tools including Postman for API testing and debugging workflows",
					],
				},
			],
		},
	...
	education: [
		{
			...
			degree:
				"Bachelor of Technology (B.Tech), Computer Science and Engineering CGPA: 7.8/10",
			period: "2022 - 2026",
			location: "Jalandhar, India",
		},
		{
			institution: "Govt Sr Sec School, Kangra, Himachal Pradesh",
			logo: "/hpbose.png",
			degree: "12th, School",
			period: "2020 - 2021",
		...
		{
			institution: "Galaxy Public School, Kangra, Himachal Pradesh",
			logo: "",
			degree: "10th, School",
			period: "2021 - 2022",
			location: "Kangra, India",
